...
mongoose
.connect("mongodb+srv://root:root@cluster0.jgmdd.mongodb.net/splitwise?retryWrites=true&w=majority", {poolSize: 500,useCreateIndex: true ,useNewUrlParser: true,useUnifiedTopology: true  })
.then(()=>{
